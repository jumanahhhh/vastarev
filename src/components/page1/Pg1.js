...
const Pg1 = () => {
  return (
    ...
    <h1> DESIGN AGENCY </h1>
    <p>We partner with AI &amp; ML&nbsp; business, guiding them from series A <br/>to series D and beyond with our expretise in</p>
    <div id="page1-some">
        <h4>Brand Design</h4>
        <h4>User Experience</h4>
        <h4>and</h4>
        <h4>Digital and Design product</h4>
    </div>
    <div className='moving-div'>
        <div className='blur-left'></div>
        <div className='move'>
            <img src="https://lazarev.kiev.ua/la24/awww.svg" alt="" decoding="async"></img>
            <img src="https://lazarev.kiev.ua/la24/awww.svg" alt="" decoding="async"></img>
            <img src="https://lazarev.kiev.ua/la24/awww.svg" alt="" decoding="async"></img>
            <img src="https://lazarev.kiev.ua/la24/awww.svg" alt="" decoding="async"></img>
            <img src="https://lazarev.kiev.ua/la24/awww.svg" alt="" decoding="async"></img>
